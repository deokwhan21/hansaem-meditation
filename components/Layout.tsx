...
export const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
    <div className="min-h-screen flex flex-col items-center py-8 px-4 md:px-8 max-w-4xl mx-auto">
      ...
      <footer className="w-full mt-16 text-center text-gray-500 text-sm no-print border-t border-gray-200 pt-8">
